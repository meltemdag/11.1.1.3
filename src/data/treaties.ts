    ...
    items: [
      {
        ...
        guidingHint: 'Bu uzun savaşların antlaşmaya zemin mi hazırladığını düşününüz.'
      },
      {
        id: 'k-c2',
        ...
        guidingHint: 'Zenta yenilgisinin devleti barış masasına yönelten bir gelişme olup olmadığını düşününüz.'
      },
      {
        id: 'k-c3',
        ...
        guidingHint: 'Mali sıkıntıların barış arayışını zorunlu kılan bir gelişme olup olmadığını değerlendiriniz.'
      },
      {
        id: 'k-e1',
        ...
        guidingHint: 'Toprak kayıplarının antlaşmanın maddeleriyle kesinleşen bir durum olup olmadığını değerlendiriniz.'
      },
      {
        id: 'k-e2',
        ...
        guidingHint: 'Savunma anlayışına geçişin antlaşmanın ardından benimsenen bir politika olup olmadığını düşününüz.'
      },
      {
        id: 'k-e3',
        ...
        guidingHint: 'Garantörlük kuralının antlaşma metninde yer alan bir şart olup olmadığını değerlendiriniz.'
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        guidingHint: 'Kaybedilen yerleri geri alma isteğinin Prut Seferi\'ni başlatan bir hedef olup olmadığını düşününüz.'
      },
      {
        id: 'p-c2',
        ...
        guidingHint: 'Sınır ihlalinin savaşı fiilen başlatan bir gelişme olup olmadığını değerlendiriniz.'
      },
      {
        id: 'p-c3',
        ...
        guidingHint: 'İsveç Kralı\'nın sığınmasının savaşa yol açan bir gelişme olup olmadığını düşününüz.'
      },
      {
        id: 'p-e1',
        ...
        guidingHint: 'Azak Kalesi\'nin geri verilmesinin antlaşma ile elde edilen bir kazanım olup olmadığını değerlendiriniz.'
      },
      {
        id: 'p-e2',
        ...
        guidingHint: 'Elçiliğin kapatılmasının antlaşmanın ardından ortaya çıkan bir durum olup olmadığını düşününüz.'
      },
      {
        id: 'p-e3',
        ...
        guidingHint: 'Karadeniz\'deki güvenliğin antlaşmayla varılan bir uzlaşma olup olmadığını değerlendiriniz.'
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        guidingHint: 'Avusturya\'nın savaşa girmesinin antlaşmaya giden süreci başlatan bir gelişme olup olmadığını düşününüz.'
      },
      {
        id: 'ps-c2',
        ...
        guidingHint: 'Belgrad\'ın düşmesinin devleti barış aramaya iten bir gelişme olup olmadığını değerlendiriniz.'
      },
      {
        id: 'ps-c3',
        ...
        guidingHint: 'Mora halkının yardım isteğinin seferi ve savaşı başlatan ilk etken olup olmadığını düşününüz.'
      },
      {
        id: 'ps-e1',
        ...
        guidingHint: 'Toprak paylaşımının antlaşma metninde karara bağlanan bir madde olup olmadığını değerlendiriniz.'
      },
      {
        id: 'ps-e2',
        ...
        guidingHint: 'Lale Devri\'ne geçişin antlaşmanın ardından başlayan bir dönem olup olmadığını düşününüz.'
      },
      {
        id: 'ps-e3',
        ...
        guidingHint: 'Batı tarzı ıslahatlara yönelmenin antlaşmanın ardından benimsenen bir anlayış olup olmadığını değerlendiriniz.'
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        guidingHint: 'Belgrad\'ı geri alma amacının savaşa girişteki temel hedef olup olmadığını düşününüz.'
      },
      {
        id: 'b-c2',
        ...
        guidingHint: 'Müttefik saldırısının savaşı ve çatışmaları başlatan bir gelişme olup olmadığını değerlendiriniz.'
      },
      {
        id: 'b-c3',
        ...
        guidingHint: 'Askeri ıslahatların savaş hazırlığı ve orduyu güçlendirme aşaması olup olmadığını düşününüz.'
      },
      {
        id: 'b-e1',
        ...
        guidingHint: 'Kalelerin Osmanlı idaresine geçmesinin antlaşmayla sağlanan bir başarı olup olmadığını değerlendiriniz.'
      },
      {
        id: 'b-e2',
        ...
        guidingHint: 'Rus gemilerine getirilen yasağın antlaşma maddesiyle kesinleştiğini düşününüz.'
      },
      {
        id: 'b-e3',
        ...
        guidingHint: 'Kapitülasyonların sürekli kılınmasının barış sürecinin ardından tanındığını düşününüz.'
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        guidingHint: 'Sınır karakollarının ihlal edilmesinin savaşı başlatan kıvılcım olup olmadığını düşününüz.'
      },
      {
        id: 'kk-c2',
        ...
        guidingHint: 'Çeşme baskınının barış masasına oturmaya mecbur bırakan bir yenilgi olup olmadığını değerlendiriniz.'
      },
      {
        id: 'kk-c3',
        ...
        guidingHint: 'Kozluca yenilgisinin antlaşmayı kabule zorlayan son askeri darbe olup olmadığını düşününüz.'
      },
      {
        id: 'kk-e1',
        ...
        guidingHint: 'Kırım\'ın bağımsızlığının antlaşma maddeleriyle yürürlüğe girdiğini değerlendiriniz.'
      },
      {
        id: 'kk-e2',
        ...
        guidingHint: 'Boğazlar geçişi ve himaye hakkının antlaşmayla tanınan yeni ayrıcalıklar olduğunu düşününüz.'
      },
      {
        id: 'kk-e3',
        ...
        guidingHint: 'Savaş tazminatı yükümlülüğünün antlaşma şartı olarak kabul edildiğini düşününüz.'
      }
    ]
  }
];
